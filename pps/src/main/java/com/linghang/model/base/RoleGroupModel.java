...
public class RoleGroupModel implements Serializable {
    ...
    List<RoleModel> items = new ArrayList<>();

    public RoleGroupModel(Long id, String groupName) {
        this.id = id;
    ...
    public void setItems(List<RoleModel> items) {
        this.items = items;
    }
    ...
    public boolean equals(Object that) {
        ...
        RoleGroupModel other = (RoleGroupModel) that;
