 ...
 * 李轻沾报警短信配置 Model
 */
public class WaterWarningNoteConfigModel extends BaseEntity implements Serializable {
    /**
     * 版本号
     */
    ...
    public String toString() {
        ...
        sb.append(", orgId=").append(super.getOrgId());
        ...
        sb.append(", stationNames=").append(stationNames);
        sb.append("]");
        return sb.toString();
    }
    ...
    public boolean equals(Object that) {
        ...
        WaterWarningNoteConfigModel other = (WaterWarningNoteConfigModel) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getStationNames() == null ? other.getStationNames() == null : this.getStationNames().equals(other.getStationNames()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getStationNames() == null) ? 0 : getStationNames().hashCode());
        return result;
    }
}