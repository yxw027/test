...
(function () {
    ...
    function a(h, g) {
        ...
        //仅绘制多边形
        this.defaultDrawingModes = [BMAP_DRAWING_POLYGON];
    ...
    a.prototype._generalHtml = function (m) {
        var h = {};
        h["hander"] = "拖拽地图";
        h[BMAP_DRAWING_MARKER] = "放置点";
        h[BMAP_DRAWING_CIRCLE] = "绘制圆";
        h[BMAP_DRAWING_POLYLINE] = "绘制折线";
        h[BMAP_DRAWING_POLYGON] = "绘制多边形";
        h[BMAP_DRAWING_RECTANGLE] = "绘制长方向";
        var n = function (o, i) {
