                ...
                <div class="row ">
                    <div class="col-lg-12" style="height: 50px;">
                        <div class="card-box" style="height: 50px;padding: 0 0 0 15px;">
                            ...
                            <@shiro.hasPermission name="waterInfo/insert">
...
<script id="detail_template" type="text/x-kendo-template">
    <div class="rootDiv">
        ...
        <#--<div class="ribbon ribbon-info">#:name#</div>-->
            ...
            <@shiro.hasPermission name="waterInfo/debug">
            ...
            <div class=' row list-content' style="clear: both">
                <div class="card-body">
                    ...
                    <ul class='col-md-4 col-12 info-ul' style='max-width: 27%;'>
                    </ul>-->
                        <ul class='col-md-4 col-12 info-ul info-ul-list' style='max-width: 100%'>
                            ...
                            <li><label>安装时间：</label>#:installTime == null ? '' : dateFormat(installTime)#</li>
...
<script>
    ...
    $(function () {
        ...
        $("#addNew").on('click', function () {
            window.location.href = "waterInfo/edit?orgId=" + _asphalt_select_orgId;
        });
        ...
        $('body').on('click', '.delete', function () {
            ...
            var $ele = $(this);
            layer.confirm("确认删除" + name + "吗？", function (e) {
                httpUtils.ajax("waterInfo/delete", {id: id}, function (data) {
                    if (data) {
        ...
        $('#asphaltList').on('click', '.edit', function () {
            var id = $(this).attr("data-id");
            window.location.href = "waterInfo/edit?stationId=" + id + "&orgId=" + _asphalt_select_orgId;
        })
    ...
    function initList(orgId) {
        ...
        httpUtils.ajax("waterInfo/selectByOrgId?orgId=" + orgId, function (data) {
            if (data) {
                var point = [];
                // 遍历站点信息
    ...
    var waterIcon = new BMap.Icon("img/waterStation.png", new BMap.Size(50, 30));
    /**
     * 添加标记
     * @param pointData
     */
    function addMarker(pointData) {
        ...
        if (pointData.length > 0) {
            for (var i = 0; i < pointData.length; i++) {
                ...
                var mk = new BMap.Marker(point, {icon: waterIcon});
                baiduMap.addOverlay(mk);
                var label = new BMap.Label(pointData[i].name, {offset: new BMap.Size(20, -10)});
                mk.setLabel(label);
            }
        }
    }
