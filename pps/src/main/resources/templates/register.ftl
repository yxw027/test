...
<div class="middle-box text-center loginscreen   animated fadeInDown">
    <div>
        ...
        <form class="m-t" role="form" action="${request.contextPath}/login">
            ...
            <a class="btn btn-sm btn-white btn-block" href="${request.contextPath}/login">Login</a>
        </form>
        <p class="m-t">
